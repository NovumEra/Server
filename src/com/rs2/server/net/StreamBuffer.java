...
public abstract class StreamBuffer {
    ...
    public static final class OutBuffer extends StreamBuffer {
         ...
         *            the value
         */
        public void writeHeader(SecureRandom cipher, int value) {
            writeByte(value + cipher.nextInt());
        }
         ...
         *            the value
         */
        public void writeVariablePacketHeader(SecureRandom cipher, int value) {
         ...
         *            the value
         */
        public void writeVariableShortPacketHeader(SecureRandom cipher, int value) {
            writeHeader(cipher, value);
            lengthPosition = buffer.writerIndex();
            writeShort(0);
        }
